<script>
  ...
  */
  ...
  let sample_data = [
		{response: "transportation", count: 31.3},
		{response: "basic needs", count: 14.1},
        {response: "supporting costs", count: 50},
        {response: "other", count: 4.6},
	]
...
<div class = "contain">
    <h2 style="width: 75%; ">What was this spent on?</h2>
